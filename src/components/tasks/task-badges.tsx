...
import { AlertTriangle, CircleAlert, Clock, Repeat } from 'lucide-react'
import { Badge } from '@/components/ui/badge'
import { statusMeta, taskTypeMeta } from '@/lib/task-meta'
import type { Task } from '@/lib/types'
import { cn, formatTime, isDueSoon, isOverdue } from '@/lib/utils'
...
/** Overdue wins over Due Soon; a finished task shows neither. */
  ...
  if (isDueSoon(task)) {
    return (
      <Badge variant="warning">
        ...
        Due soon · {formatTime(task.due_date)}
      </Badge>
    )
  }
